          ...
          <div style={{ maxWidth:1200, margin:"0 auto", position:"relative" }}>
            ...
            {submitted ? (
              ...
              <div style={{ display:"flex", flexWrap:"wrap", gap:12 }}>
                ...
                {(proposal as any).advisorPhone && (() => {
                  const raw: string = (proposal as any).advisorPhone as string;
                  const clean = raw.replace(/[\s\-().+]/g, "");
                  const wa = clean.startsWith("0") ? "971" + clean.slice(1) : clean.startsWith("971") ? clean : "971" + clean;
                  return (
                    <>
                      <a href={`tel:${raw}`}
                        style={{ display:"flex", alignItems:"center", gap:10, padding:"16px 28px", borderRadius:10, background:"rgba(255,255,255,0.07)", color:WHITE, border:"1px solid rgba(255,255,255,0.15)", cursor:"pointer", fontSize:14, fontWeight:600, textDecoration:"none" }}>
                        <Phone style={{ width:16, height:16 }} /> Call Representative
                      </a>
                      <a href={`https://wa.me/${wa}`} target="_blank" rel="noopener noreferrer"
                        style={{ display:"flex", alignItems:"center", gap:10, padding:"16px 28px", borderRadius:10, background:"rgba(37,211,102,0.12)", color:"#25d366", border:"1px solid rgba(37,211,102,0.3)", cursor:"pointer", fontSize:14, fontWeight:600, textDecoration:"none" }}>
                ...
                <a href="tel:800744"
                  style={{ display:"flex", alignItems:"center", gap:10, padding:"16px 28px", borderRadius:10, background:"rgba(255,255,255,0.07)", color:WHITE, border:"1px solid rgba(255,255,255,0.15)", cursor:"pointer", fontSize:14, fontWeight:600, textDecoration:"none" }}>
                  <Phone style={{ width:16, height:16 }} /> Toll Free: 800 744
                </a>
